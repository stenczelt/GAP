...
def refit_generic(state: HybridMD):
    ...
    with open(f"stdout_{refit_settings.gp_name}_at_{time()}__.txt", "w") as file:
        file.write(proc.stdout)
    with open(f"stderr_{refit_settings.gp_name}_at_{time()}__.txt", "w") as file:
